...
// takes time in seconds and converts it to the nearet time unit
// if less than a minute, returns 'just now'
// if less than an hour, returns the number of minutes
// if less than a day, returns the number of hours
// if less than a week, returns the number of days
// if less than a month, returns the number of weeks
// if less than a year, returns the number of months
// if more than a year, returns the number of years
