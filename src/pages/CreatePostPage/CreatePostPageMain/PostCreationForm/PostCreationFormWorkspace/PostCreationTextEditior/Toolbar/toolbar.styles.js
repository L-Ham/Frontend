export const classes = {
    ...
    toolbarButton: `swtch-to-mdwn-btn relative
     ...
     cursor-pointer items-center justify-center
      whitespace-pre-wrap break-keep rounded-full 
      border-DEFAULT border-solid border-transparent
       bg-transparent px-[8px] py-[4px] text-center text-[12px]/[16px] font-[700]`,
};
