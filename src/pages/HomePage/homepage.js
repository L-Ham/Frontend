...
function HomePage() {
    return (
        <div className='order-2 mx-auto box-border flex
            h-screen w-full flex-col md:px-4 nd:col-start-2 nd:w-[1120px] nd:max-w-[calc(100vw-272px)]'>
            <div className='flex h-screen w-full gap-4 pb-8'>
                <div className='h-screen w-full scroll-mt-[48px]
