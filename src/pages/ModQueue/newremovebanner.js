 ...
 */
function Newremovebanner({approvedByUserame, disapprovedByUserame
         ...
         rounded bg-[#ffdacc] px-3 py-2">
                <div className="mr-2 size-7 flex-[0_0_28px]">
                    ...
                    object-center indent-[-9999px] text-[color:var(--newCommunityTheme-body)]"
                        src={imageurltoputdisapproved}/>
                    </div></div><div className="w-full self-center">
                    <p className="text-xs font-bold  text-[color:var(--newRedditTheme-bodyText)]">Removed</p>
                    <p><a className="no-underline"
                        href="https://www.reddit.com/user/3abwareth"
                        target="_blank" rel="noopener noreferrer">u/{disapprovedByUserame}
                    </a> 1 month ago</p></div>
