...
const FeedSettings = () => {
    return (
        <div style={{backgroundColor: 'white', maxWidth: '600px', selfJustify: 'left', marginLeft: '50px'}}>
            ...
            <SettingsGenericItemRight head="Show mature (18+) content" text="See NSFW (Not Safe for Work) mature
       and adult images, videos, written content
       , and other media in your Reddit feeds and search results." thirdComponent={'Toggle'} />

            <SettingsGenericItemRight head="Enable home feed recommendations" text="Allow us to introduce recommended posts
 in your home feed." thirdComponent={'Toggle'} />

            <SettingsGenericItemRight head="Autoplay media" text="Play videos and gifs automatically
 when in the viewport." thirdComponent={'Toggle'} />

            <SettingsGenericItemRight head="Reduce Animations" text="Reduce animations on posts,
 comments, and feeds." thirdComponent={'Toggle'} />

            <SettingsGenericItemRight head="Community themes" text="Use custom themes for all communities.
       You can also turn this off on a per community basis." thirdComponent={'Toggle'} />


            <SettingsGenericItemRight head="Community content
      ...
      " thirdComponent={'rm'} />
            ...
            <SettingsGenericItemRight head="Global content view" text="Choose how you would like
 content displayed in feeds. This control is also found above your feed.
      " thirdComponent={'rm'} />


            <SettingsGenericItemRight head="Open posts in new tab" text="Enable to always open posts in a new tab.
       " thirdComponent={'Toggle'} />

            <SettingsTabHeading text="POST PREFERENCES" />


            <SettingsGenericItemRight head="Default to markdown" text="When posting, your input will default
