    ...
    return (
      ...
      " thirdComponent={'Toggle'} />
       ...
       " thirdComponent={'Toggle'} />
            ...
            <SettingsGenericItemRight head="Alchohol" text="Allowed
         " thirdComponent={'Toggle'} />
            <SettingsGenericItemRight head="Dating" text="Allowed
         " thirdComponent={'Toggle'} />
            <SettingsGenericItemRight head="Gambling" text="Allowed
         " thirdComponent={'Toggle'} />
            <SettingsGenericItemRight head="Pregnancy and parenting" text="Allowed
         " thirdComponent={'Toggle'} />
            <SettingsGenericItemRight head="Weight loss" text="Allowed
         " thirdComponent={'Toggle'} />

            <SettingsTabHeading text="ADVANCED SECURITY" />
            <SettingsGenericItemRight head="Use two-factor authentication"
