...
function Leavmod({onxclick, name, onnewleave}) {
    ...
    return (
        <div data-testid='webvg3rn4wt6'className='pointer-events-none fixed left-0 top-0 z-[55]
             ...
             border border-solid border-[#EDEFF1] bg-white
              shadow-[0_2px_20px_0_rgba(0,0,0,0.3)]" role="dialog" tabIndex="-1">
                <section className='min-w-[410px] max-w-[538px] shadow-[0_2_15px_rgba(0,0,0,0.3)]'>
                    <header data-testid='wrhebe5nyj' className="rounded-t border-b border-solid border-b-[#EDEFF1] p-4">
                        <div className="flex flex-row">
                            <div className="w-full flex-[1_1_100%] text-[var(--newCommunityTheme-bodyText)]">
                                ...
                                <button data-testid='wvebqt4ww' className="border-[none] p-0 text-xs font-bold
                    ...
                    <div className="p-4 text-[var(--newCommunityTheme-bodyText)]">
                        <p data-testid='3567k8umnhbgvfr' className="block text-sm font-normal leading-[21px]
                    ...
                    border-t border-solid border-t-[#EDEFF1] bg-[#EDEFF1] p-4">
                        <button data-testid='myju67t54redcf' role="button" tabIndex="0"
                        ...
                        <button data-testid='e34t5yh6yjnmbnmjytr' role="button" tabIndex="0" disabled=""
