...
function Moderatorentry({username, imageurl}) {
    ...
    return (
        ...
        <div data-testid='wvbe nem56tr' className='box-border flex h-[60px] w-full flex-row
            ...
            <div data-testid='bhtrne5ynh'className="min-w-[220px] rounded-lg text-sm font-medium
                                         leading-[18px] text-[var(--newCommunityTheme-bodyText)] hover:bg-[#edeff1]">
                <a data-testid='cfq3vwrgvqrg' className="inline-block rounded py-1
                                                 pl-1 pr-2" href="/user/mohamed">
                    <span className="mr-1.5 inline-block align-middle"
                        style={{height: '32px', width: '32px'}}>
                        <div className=" relative h-full ">
                            <img data-testid='q3rbvq3rbgvq3'
                                alt="User avatar"
